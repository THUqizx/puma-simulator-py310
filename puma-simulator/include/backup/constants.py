...
# Note the read and write lat/pow are for entire xbar  +++不改也行
xbar_rd_lat = 328.0 * 1000 * (1/32.0)  
xbar_wr_lat = 351.0 * 1000 * (1/32.0)

# the following is lumped power for xbar rd/wr (for whole array) - includes peripherals  +++不改也行
